    ...
    <OuterContainer>
      <MainContainer contentWidth={contentWidth}>
        <MainGrid>
          ...
          <HeaderContainer image={"image"}></HeaderContainer>
          <LeftSidebarContainer
            className={showLeftSideBar ? undefined : "hidden"}
          ...
          <RightSidebarContainer
            className={showLRightSideBar ? undefined : "hidden"}
            sidebarWidth={sidebarWidth}
          >
