...
const { setGlobalState: baseSetGlobalState, useGlobalState } = createGlobalState<GlobalStates>(initialState);
...
const setGlobalState = <K extends keyof GlobalStates>(key: K, value: GlobalStates[K]) => {
