...
const CommentForm = (p: CommentFormProps) => {
    ...
    const allowRate = (editId && userEmail === email) || userIsAdmin || !hasGivenRating;
    return (
        <div
            style={{
                display: "grid",
        ...
        >
            ...
            <div>
                <Rating value={rating ?? undefined} cancel={false} onChange={onChangeRating} disabled={!allowRate} />
            </div>
            {ratingError && (
                <>
                    <div />
